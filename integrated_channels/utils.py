...
def is_already_transmitted(transmission, enterprise_enrollment_id, grade, subsection_id=None):
    ...
    Args:
        ...
        subsection_id (Optional): The id of the subsection, needed if there exist multiple audits per course
    """
    try:
        ...
        if subsection_id:
            already_transmitted.filter(subsection_id=subsection_id)

        already_transmitted = already_transmitted.latest('id')
